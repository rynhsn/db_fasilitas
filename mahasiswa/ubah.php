...
cek_login();
$nim = $_GET['nim'];
$result = tampilMahasiswaPerNim($nim);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (ubahMahasiswa($nim, $nama, $prodi, $fakultas, $angkatan, $jenis_kelamin)) {
...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <!-- Page content-->
            <div class="container-fluid">
                <h1 class="mt-4">Ubah Mahasiswa</h1>
                <a href="index.php" class="btn btn-sm btn-danger mb-2 rounded-0">Kembali</a>
                <form action="" method="post">
                    <div class="row">
                        <div class="form-group col-6">
                            <label for="nim">NIM:</label>
                            <input type="text" class="form-control rounded-0" id="nim" name="nim" value="<?= $row['nim']; ?>" required>
                        </div>
                        <div class="form-group col-6">
                            <label for="nama">Nama:</label>
                            <input type="text" class="form-control rounded-0" id="nama" name="nama" value="<?= $row['nama']; ?>" required>
                        </div>
                        <div class="form-group col-6">
                            <label for="prodi">Prodi:</label>
                            <input type="text" class="form-control rounded-0" id="prodi" name="prodi" value="<?= $row['prodi']; ?>" required>
                        </div>
                        <div class="form-group col-6">
                            <label for="fakultas">Fakultas:</label>
                            <input type="text" class="form-control rounded-0" id="fakultas" name="fakultas" value="<?= $row['fakultas']; ?>" required>
                        </div>
                        <div class="form-group col-6">
                            <label for="angkatan">Angkatan:</label>
                            <input type="text" class="form-control rounded-0" id="angkatan" name="angkatan" value="<?= $row['angkatan']; ?>" required>
                        </div>
                        <div class="form-group col-6">
                            <label for="jenis_kelamin">Jenis Kelamin:</label>
                            <select class="form-select rounded-0" aria-label="jenis_kelamin" id="jenis_kelamin" name="jenis_kelamin" required>

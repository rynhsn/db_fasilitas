    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="#">Mahasiswa</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <a href="tambah.php" class="btn btn-sm btn-primary mb-2 rounded-0">Tambah Mahasiswa</a>
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="ubah.php?nim=<?= $row['nim']; ?>" class="btn btn-sm btn-success rounded-0">Ubah</a>  
                            <a href="#" onclick="hapusMahasiswa('<?= $row['nim']; ?>')" class="btn btn-sm btn-danger rounded-0">Hapus</a>
                        </td>
                    </tr>
                    <?php
                    }
    ...
    <script>
        function hapusMahasiswa(nim) {
            if (confirm("Apakah Anda yakin ingin menghapus data ini?")) {
                window.location = "hapus.php?nim=" + nim;
            }
        }
    </script>
</body>
